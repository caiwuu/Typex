...
export const mockData =
{
  data: [
    ...
    //     { data: '是一款全新架构的编辑器内核，该内核不依赖contenteditable;自主实现', formats: { color: "#999" } },
    //   ],
    //   formats: { paragraph: true },
    // },
    // {
    //   data: [
    //     { data: '了光标、模拟输入、模拟', formats: { color: "#999" } },
    //   ],
    //   formats: { paragraph: true },
    // },
    {
      data: [
        { data: '输入、模拟选区;数据驱动，组件化，插件化，支持多光标，跨平台的设计。优秀的格式排版系统避免了脏标签的产生（打开控制台你会发现它的标签非常简洁）。', formats: { color: "#999" } },
      ],
      formats: { paragraph: true },
    },
    {
